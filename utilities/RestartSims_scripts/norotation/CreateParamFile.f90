PROGRAM CreateParamFile
  ...
  CHARACTER(len=10)   :: Pr_str,tau_str,Rm1_str
  ...
  CALL GET_COMMAND_ARGUMENT(5,xres_str)
  CALL GET_COMMAND_ARGUMENT(6,yres_str)
  CALL GET_COMMAND_ARGUMENT(7,zres_str)
  CALL GET_COMMAND_ARGUMENT(8,Lx_str)
  CALL GET_COMMAND_ARGUMENT(9,Ly_str)
  CALL GET_COMMAND_ARGUMENT(10,Lz_str)
  CALL GET_COMMAND_ARGUMENT(11,numTs_str)
  CALL GET_COMMAND_ARGUMENT(12,proc1_str)
  CALL GET_COMMAND_ARGUMENT(13,proc2_str)
